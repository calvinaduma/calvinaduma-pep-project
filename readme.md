...
## 1: The API should be able to process new User registrations.
...
## 2: The API should be able to process User logins.
...
## 3: The API should be able to process the creation of new messages.
...
## 4: The API should be able to retrieve all messages.

As a user, I should be able to submit a GET request on the endpoint GET localhost:8080/messages.

- The response body should contain a JSON representation of a list containing all messages retrieved from the database. It is expected for the list to simply be empty if there are no messages. The response status should always be 200, which is the default.

## 5: The API should be able to retrieve a message by its ID.
...
## 6: The API should be able to delete a message identified by a message ID.
...
## 7: The API should be able to update a message text identified by a message ID.
...
## 8: The API should be able to retrieve all messages written by a particular user.
